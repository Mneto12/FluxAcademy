...
<div class="row col-lg-12">
  <div class="col-lg-4" style="padding-top: 20px; padding-left: 30px">
      ...
      <div class="modal-body">
        <form method="POST" id="formUsuario" enctype="multipart/form-data">
          <div class="form-group">
            ...
            <input type="int" required class="form-control" name="cedula" id="cedula" placeholder="Ingrese el nombre de la pelicula">
          </div>
          <div class="form-group">
            <label for="nombre"><strong>Nombre</strong></label>
            <input type="text" required class="form-control" name="nombre" id="nombre" placeholder="Ingrese el nombre de la pelicula">
          </div>
          <div class="form-group">
            <label for="apellido"><strong>Apellido</strong></label>
            <input type="text" required class="form-control" name="apellido" id="apellido" placeholder="Ingrese el nombre de la pelicula">
          </div>
          <div class="form-group">
            <label for="genero"><strong>Genero</strong></label>
            <input type="text" required class="form-control" name="genero" id="genero" placeholder="Ingrese el nombre de la pelicula">
          </div>
          <div class="form-group">
            <label for="fecha_nacimiento"><strong>Fecha de Nacimiento</strong></label>
            <input type="date" required class="form-control" name="fecha_nacimiento" id="fecha_nacimiento" placeholder="Ingrese el nombre de la pelicula">
          </div>
          <div class="form-group">
            <label for="nombre_usuario"><strong>Nombre de Usuario</strong></label>
            <input type="text" required class="form-control" name="nombre_usuario" id="nombre_usuario" placeholder="Ingrese el nombre de la pelicula">
          </div>
          <div class="form-group">
            <label for="correo"><strong>Correo</strong></label>
            <input type="text" required class="form-control" name="correo" id="correo" placeholder="Ingrese el nombre de la pelicula">
          </div>
          <div class="form-group">
            <label for="contrasena"><strong>Contraseña</strong></label>
            <input type="text" required class="form-control" name="contrasena" id="contrasena" placeholder="Ingrese el nombre de la pelicula">
          </div>
          <div class="form-group">
      ...
      <div class="modal-body">
        <form method="post" id="formEdit">
          ...
          <div class="col-sm-3">
            ...
            <input type="int" required class="form-control" name="cedulaEdit" id="cedulaEdit" placeholder="Ingrese el nombre de la pelicula">
          </div>
          <div class="form-group">
            <label for="nombreEdit"><strong>Nombre</strong></label>
            <input type="text" required class="form-control" name="nombreEdit" id="nombreEdit" placeholder="Ingrese el nombre de la pelicula">
          </div>
          <div class="form-group">
            <label for="apellidoEdit"><strong>Apellido</strong></label>
            <input type="text" required class="form-control" name="apellidoEdit" id="apellidoEdit" placeholder="Ingrese el nombre de la pelicula">
          </div>
          <div class="form-group">
            <label for="generoEdit"><strong>Genero</strong></label>
            <input type="text" required class="form-control" name="generoEdit" id="generoEdit" placeholder="Ingrese el nombre de la pelicula">
          </div>
          <div class="form-group">
            <label for="fecha_nacimientoEdit"><strong>Fecha de Nacimiento</strong></label>
            <input type="date" required class="form-control" name="fecha_nacimientoEdit" id="fecha_nacimientoEdit" placeholder="Ingrese el nombre de la pelicula">
          </div>
          <div class="form-group">
            <label for="nombre_usuarioEdit"><strong>Nombre de Usuario</strong></label>
            <input type="text" required class="form-control" name="nombre_usuarioEdit" id="nombre_usuarioEdit" placeholder="Ingrese el nombre de la pelicula">
          </div>
          <div class="form-group">
            <label for="correoEdit"><strong>Correo</strong></label>
            <input type="text" required class="form-control" name="correoEdit" id="correoEdit" placeholder="Ingrese el nombre de la pelicula">
          </div>
          <div class="form-group">
            <label for="contrasenaEdit"><strong>Contraseña</strong></label>
            <input type="text" required class="form-control" name="contrasenaEdit" id="contrasenaEdit" placeholder="Ingrese el nombre de la pelicula">
          </div>
          <div class="form-group">
          ...
          <div class="modal-footer">
            <button type="button" class="btn btn-danger" data-dismiss="modal">Cancelar</button>
            <button type="button" name="guardar" class="btn btn-primary" onclick="GuadarEdit()">Guardar</button>
          </div>
        </form>
      </div>
    </div>
