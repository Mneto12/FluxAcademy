            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Descubre todo lo que Flux Academy tiene para ti</h1>
                        ...
                        <div class="card mb-4">
                            <div class="card-body">
                                <p class="mb-0">
                                    Bienvenido al menú de ayudas de Flux Academy. En este apartado tendrás acceso a nuestro material de documenación de la plataforma Flux Academy.
                                    Toma un atajo a través de nuestro menú interactivo y accede a cualquier información que desees conocer. 
                                </p>
                            </div>
                        </div>

                        <div class="list-group">
                            <a href="#User" class="list-group-item list-group-item-action">01. Dashboard</a>
                            <a href="#User1" class="list-group-item list-group-item-action">02. Mi Perfil</a>
                            <a href="#User2" class="list-group-item list-group-item-action">03. Mis Cursos</a>
                            <a href="#User3" class="list-group-item list-group-item-action">04. Ver material de Mis Cursos</a>
                            <a href="#User11" class="list-group-item list-group-item-action">05. Generar certificado</a>
                            <a href="#User4" class="list-group-item list-group-item-action">06. Lista de Cursos</a>
                            <a href="#User12" class="list-group-item list-group-item-action">07. Inscribirse en cursos</a>
                            <a href="#User5" class="list-group-item list-group-item-action">08. Contáctanos</a>
                            <a href="#User6" class="list-group-item list-group-item-action">09. Nuestra Página Web</a>
                            <a href="#User7" class="list-group-item list-group-item-action">10. Preguntas y Respuestas Frecuentes</a>
                            <a href="#User8" class="list-group-item list-group-item-action">11. Iniciar Sesión</a>
                            <a href="#User9" class="list-group-item list-group-item-action">12. Recuperar contraseña</a>
                            <a href="#User10" class="list-group-item list-group-item-action">13. Registrar</a>
                        </div>
                        <br>
                        <div id="User" class="card mb-3">
                            <img class="card-img-top" src="../assets/img/Ayuda-User.jpg" alt="Card image cap">
                                    <div class="card-body">
                                        ...
                                        <a href="#User4"> <p class="card-text"><small class="text-muted">Te puede interesar: Lista de Cursos</small></p></a>
                                    </div>  
                        </div>
                        ...
                        <div id="User4" class="card mb-3">
                            <img class="card-img-top" src="../assets/img/Ayuda-User_4.jpg" alt="Card image cap">
                                    <div class="card-body">
                                        ...
                                        <a href="#User12"> <p class="card-text"><small class="text-muted">Te puede interesar: Inscribir cursos</small></p></a>
                                    </div>  
                        </div>
                        <div id="User12" class="card mb-3">
                            <img class="card-img-top" src="../assets/img/Ayuda-User_4.jpg" alt="Card image cap">
                                    <div class="card-body">
                                        ...
                                        <a href="#User2"> <p class="card-text"><small class="text-muted">Te puede interesar: Mis Cursos</small></p></a>
                                    </div>  
                        </div>
                        <div id="User5" class="card mb-3">
                            <img class="card-img-top" src="../assets/img/Ayuda-User_5.jpg" alt="Card image cap">
                                    <div class="card-body">
                                        ...
                                        <a href="#User"> <p class="card-text"><small class="text-muted">Te puede interesar: Dashboard</small></p></a>
                                    </div>  
                        </div>
