...
function Header() {
	...
	$this->setXY(65, 30);
	$this->Cell(120, 8, 'Listado de Usuarios', 0, 1, 'C', 0);
...
function CheckPageBreak($h,$setX)
{
    ...
    $this->Cell(22, 8, utf8_decode('Género'), 1, 0, 'C', 0);
    $this->Cell(32, 8, ' F. Nacimiento', 1, 0, 'C', 0);
    $this->Cell(60, 8, utf8_decode('Correo'), 1, 1, 'C', 0);
...
$pdf->SetFont('Helvetica', 'B', 13);
    ...
    $pdf->Cell(30, 8, utf8_decode('Apellido'), 1, 0, 'C', 0);
    $pdf->Cell(22, 8, utf8_decode('Género'), 1, 0, 'C', 0);
    $pdf->Cell(32, 8, ' F. Nacimiento', 1, 0, 'C', 0);
    $pdf->Cell(60, 8, utf8_decode('Correo'), 1, 1, 'C', 0);
// -------TERMINA----ENCABEZADO------------------
...
$pdf->SetWidths(array(25, 30, 30,22,32,60)); //???
//Alineacion de cada Columna
$pdf->SetAligns(array('C','C','C','C','C','C'));

for ($i = 0; $i < count($data); $i++) {

	$pdf->Row(array($data[$i]['idUsuario'],utf8_decode($data[$i]['nombre']),utf8_decode($data[$i]['apellido']),$data[$i]['genero'],$data[$i]['fecha_nacimiento'],$data[$i]['correo']),5);
}
